<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" @submit.navite.prevent :inline="true" v-show="showSearch" label-width="68px">
...
<!--        </el-form-item>-->
        ...
        <el-form-item label="货道数" prop="vmRow">
          <el-input-number v-model="form.vmRow" :min="1" :max="10" />
          <span>行</span>
          <el-input-number v-model="form.vmCol" :min="1" :max="10" />
          <span>列</span>
        </el-form-item>
